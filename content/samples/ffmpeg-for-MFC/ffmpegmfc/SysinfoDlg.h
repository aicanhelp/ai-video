...
class Sysinfosubof : public CDialogEx
{
	DECLARE_DYNAMIC(Sysinfosubof)

public:
	Sysinfosubof(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~Sysinfosubof();

	// 对话框数据
	enum { IDD = IDD_SYSINFOSUB_OF };
