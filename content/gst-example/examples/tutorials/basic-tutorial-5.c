...
#endif
    /* Pass it to playbin, which implements XOverlay and will forward it to the
     * video sink */
...
static gboolean draw_cb(GtkWidget *widget, cairo_t *cr, CustomData *data) {
    if (data->state < GST_STATE_PAUSED) {
         ...
         * window. It is used by GStreamer for other reasons, so it will always be
         * available to us. */
...
int main(int argc, char *argv[]) {
    ...
    gchar *file1 = "https://www.freedesktop.org/software/gstreamer-sdk/data/media/sintel_trailer-480p.webm";
    gchar *file2 = "file:////home/modongsong/data/test-data/sintel_trailer-480p.webm";

    /* Set the URI to play */
    g_object_set(data.playbin, "uri", file2, NULL);
